...
def get_parser(parser=None):
    ...
    parser.add_argument("--dims", type=int, nargs="*", required=False)
    parser.add_argument(
        "--smiles_embedding",
        type=str,
    ...
    parser.add_argument("--dataset_index", type=int, default=13, required=False)
    parser.add_argument("--base_path", type=str, default='/local_storage/datasets/farzaneh/alignment_olfaction_datasets/data', required=False)
    parser.add_argument("--input_file_indices", type=str, default='curated_datasets/embeddings/pom/gslf-splits-idx-', required=False)
    parser.add_argument("--input_file_data", type=str,  required=True)
